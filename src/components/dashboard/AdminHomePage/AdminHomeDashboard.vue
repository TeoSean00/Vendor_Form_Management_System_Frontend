...
export default {
  ...
  setup() {
    ...
    //   }
    //   console.log(
    //     "form breakdowns array before: ",
    //     FileStatusBarChart.value.datasets[0].data,
    //     "form breakdowns array after: ",
    //     defaultValues
    //   );
    ...
    const filteredFormData = computed(() => {
      console.log("CHECKING DATAAAA ", formData.value);
    ...
    const barChartData = computed(() => {
      console.log("COMPUTING BAR CHART DATA ", filteredFormData);
      return {
