<template>
  <div
    ...
    style="width: 100%"
  >
    <nav class="navbar navbar-expand navbar-light px-0 flex d-flex justify-content-between" style="width: 100%">
      <div>
        <router-link
          to="/"
      ...
      <div>
        ...
        <div v-if="currentUser" class="navbar-nav ml-auto text-end " style="">
